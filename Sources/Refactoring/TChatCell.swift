...
public protocol TChatViewModelProtocol {
    var avatar: URL? { get }
...
public final class TChatCell: MGSwipeTableCell, Localizable, ChatCell {
    ...
    public weak var chatCellDelegate: TChatCellDelegate?
...
//    public func update(viewModel: TChatViewModelProtocol, identity: ALKIdentityProtocol?, placeholder: UIImage? = nil, disableSwipe: Bool) {
//
